...
float cha[7]={0.0,  0.005, 0.027,  0.048,  0.976, 0.1469, 0.3922};
float fa[6]={0.0, 0.05, 0.1384, 0.1669, 0.2069, 0.3637};

float dia[][7][2]={{{1e10,7.5},{7.5,4.5},{4.5,2.9},{2.9,1.3},{1.3,1.0},{1.0,0.8}},//横排代表相同中间电感不同两边电感差值，竖排代表相同两边电感差值不同中间电感值
                  {{10.0,7.2},{7.0,4.5},{4.5,2.8},{2.8,1.2},{1.2,0.9},{0.9,0.7}},
                  {{4.0,3.2},{3.2,2.8},{2.8,2.0},{2.0,1.1},{1.1,0.8},{0.8,0.6}},
                  {{2.6,2.2},{2.2,1.8},{1.8,1.4},{1.4,1.1},{1.1,0.8},{0.8,0.6}},
                  {{2.1,1.7},{1.7,1.2},{1.2,1.0},{1.0,0.5},{0.5,0.3},{0.3,0.1}}};
...
void calcu_track(void)
{
  ...
  if(((float)(V_L+V_R)/2.0/adc_precise)>0.827)
    if(e_p<8.0)
      e_p=8.0;
  if(si==-1)e_p=-e_p;
  }
